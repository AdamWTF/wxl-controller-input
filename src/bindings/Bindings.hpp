...
struct ActionSlot {
    unsigned slot{};
    friend bool operator==(const ActionSlot &, const ActionSlot &) = default;
};
struct WowBinding {
    std::string command;
    friend bool operator==(const WowBinding &, const WowBinding &) = default;
};
struct KeyBinding {
    std::string key;
...
struct Unassigned {
    friend bool operator==(const Unassigned &, const Unassigned &) = default;
};
